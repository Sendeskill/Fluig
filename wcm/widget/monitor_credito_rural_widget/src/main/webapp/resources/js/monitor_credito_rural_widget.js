...
function serviceCreateMonitorCreditoRural(cb, data) {
    const options = {
        ...
        type: 'POST',
        data: JSON.stringify({
                "datasetId" : "dsMonitorCreditoRural",
                "filterFields" : ["_action", "createMonitorCreditoRural", "data", data],
                "limit" : "1000"
            }),
        loading: true
    };
...
function serviceSearchMonitorCreditoRural(cb) {
    const options = {
        url: '/api/public/ecm/dataset/search',
        contentType: 'application/json',
        dataType: 'json',
...
$(function(){
    ...
    $('#btn-filtrar').on('click',function() {
        ...
        serviceSearchMonitorCreditoRural(function(err, data) {
            var i = 0;
    ...
    $('#btn-analisar').on('click',function() {
        ...
        serviceCreateMonitorCreditoRural(function(err, data) {
